...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.submit_button.setFont(QFont("Roboto"))

        self.reset_button = QPushButton("Reset")
        self.reset_button.setFont(QFont("Roboto"))
    ...
    def greet(self):
        ...
        if not name and not nim and not hobby:
            QMessageBox.warning(self, "Input Error", "input tidak boleh kosong")
            return
        if not name:
            QMessageBox.warning(self, "Input Error", "masukkan nama!")
        elif not nim:
            QMessageBox.warning(self, "Input Error", "masukkan NIM!")
        elif not nim.isdigit():
            QMessageBox.warning(self, "Input Error", "NIM harus angka!")
        elif not hobby:
            QMessageBox.warning(self, "Input Error", "masukkan hobi!")
